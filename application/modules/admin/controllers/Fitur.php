...
class Fitur extends Admin_Base_Controller
{
    ...
    public function daftar()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('fitur', 'Daftar Fitur', 'Daftar Fitur', 'Daftar Fitur');

            // data Grid view fields
            $crud->columns('judul_fitur', 'status');

            // Insert form
            $crud->add_fields('judul_fitur','keterangan');

            // Update form
            $crud->edit_fields('judul_fitur','keterangan','status');
            ...
            // Required fields
            $crud->required_fields('judul_fitur','judul_fitur');
